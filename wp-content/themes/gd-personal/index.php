...
<head>
    ...
    <!-- Favicons -->
    <link href="<?php echo get_template_directory_uri() ?>/assets/img/GauravDalwadiIcon.svg" rel="icon">
    <link href="<?php echo get_template_directory_uri() ?>/assets/img/GauravDalwadiIcon.svg" rel="apple-touch-icon">
    ...
    <link href="<?php echo get_template_directory_uri() ?>/assets/vendor/splide-4.1.3/dist/css/themes/splide-sea-green.min.css" rel="stylesheet">
    ...
    <main id="main" class="px-2">
        ...
        <section id="about" class="about">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <img src="<?php echo get_template_directory_uri() ?>/assets/img/profile-img.jpg" class="img-fluid rounded" alt="">
                    </div>
    ...
    <footer id="footer">
        <div class="container">
            ...
            <div class="social-links">
                ...
                <script src="<?php echo get_template_directory_uri() ?>/assets/vendor/particles/particles.min.js"></script>
                <script src="<?php echo get_template_directory_uri() ?>/assets/vendor/splide-4.1.3/dist/js/splide.min.js"></script>
